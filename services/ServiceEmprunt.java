...
public class ServiceEmprunt implements Runnable {
	...
	public ServiceEmprunt(Socket socket, Bibliotheque b) {
		this.client = socket;
	...
	public void run() {
		System.out.println("Bienvenue dans le service emprunt " + this.client.getInetAddress());
		try {
			...
			while (true) {
				...
				synchronized(biblio) {
					out.println(biblio.emprunterLivre(numLivre, numAbonne)); //affichage du message
				}
			}
		}
		catch (Exception e) {
			System.err.println("Fin du service emprunt : " + e);
		} 
